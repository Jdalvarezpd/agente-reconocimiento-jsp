...
Una aplicación web moderna, rápida y responsiva diseñada para **J.S.P Abogados**. Esta herramienta permite la captura y subida de imágenes de siniestros, integrándose directamente con un flujo de trabajo en **n8n** para procesar la imagen y extraer información clave de manera automatizada.

## ✨ Características Principales

- **📱 Mobile-First & Cámara Nativa**: Al acceder desde un dispositivo móvil, el botón "Activar cámara" abre directamente la cámara trasera del dispositivo.
- **🖼️ Subida de Archivos**: Permite seleccionar imágenes desde el almacenamiento local del ordenador o galería.
- **🎨 Diseño Premium**: Interfaz moderna utilizando *Glassmorphism*, gradientes suaves y animaciones fluidas para una excelente experiencia de usuario (UX).
...
El flujo de n8n debe devolver un objeto JSON con las siguientes llaves para que la Tarjeta de Resultados se renderice correctamente:
...
- `Correo_electrónico`
- `conductor`
- `Comentario-Descripción Hechos` (o variables que inicien con esta frase).

---
*Desarrollado para automatizar y mejorar la gestión de siniestros.*
